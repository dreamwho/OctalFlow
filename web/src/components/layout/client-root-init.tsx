...
export function ClientRootInit({ children }: { children: ReactNode }) {
    ...
    useEffect(() => {
        ...
        window.addEventListener("octalaicanvas-system-config-missing", handleMissingConfig);
        return () => window.removeEventListener("octalaicanvas-system-config-missing", handleMissingConfig);
    }, [message]);
