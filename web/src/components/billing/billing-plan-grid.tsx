    ...
    return (
        ...
        >
            <div className="relative flex min-h-7 items-center justify-between gap-3">
                <span className="text-[10px] font-semibold tracking-[0.14em] text-stone-400 sm:text-[11px] sm:tracking-[0.16em] dark:text-stone-500">OctalFlow PASS · {String(index + 1).padStart(2, "0")}</span>
                {promotion ? (
