                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <LabeledControl label="Logo URL">
                                <div className="flex gap-2">
                                    <Input value={settings.site.logoUrl} maxLength={2000} placeholder="/brand/dreamyo/mark.png 或 https://..." onChange={(event) => updateSiteSetting("logoUrl", event.target.value)} />
                            ...
                            <LabeledControl label="浏览器图标 URL">
                                <div className="flex gap-2">
                                    <Input value={settings.site.iconUrl} maxLength={2000} placeholder="/brand/dreamyo/mark.png、/favicon.ico 或 https://..." onChange={(event) => updateSiteSetting("iconUrl", event.target.value)} />
