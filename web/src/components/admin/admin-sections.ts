...
export const ADMIN_SECTION_PERMISSIONS: Record<AdminSectionKey, readonly AdminPermission[]> = {
    ...
    canvasActions: ["upstream.manage"],
    magicProxy: ["upstream.manage"],
    genericProxy: ["upstream.manage"],
    runninghub: ["upstream.manage"],
    geminiai: ["upstream.manage"],
    dolaApi: ["upstream.manage"],
    geminiTools: ["upstream.manage"],
    chatgptApi: ["upstream.manage"],
    minimax: ["upstream.manage"],
    tencentMusic: ["upstream.manage"],
    qwenAudio: ["upstream.manage"],
    dreamina: ["upstream.manage"],
