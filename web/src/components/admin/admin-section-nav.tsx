...
export const adminSections: AdminSection[] = [
    ...
    { key: "ipwo", label: "IPWO 配置", description: "配置 IPWO 代理来源、诊断连通性，并控制是否作为 GPTAPI 的原生代理出口。", shortDescription: "IPWO 来源", icon: <Globe className="size-4" /> },
...
export const adminSectionGroups: AdminSectionGroup[] = [
    ...
    { title: "上游配置", items: sectionsFor(["channels", "magicProxy", "runninghub", "geminiai", "geminiTools", "chatgptApi", "ipwo", "dreamina", "skills"]) },
