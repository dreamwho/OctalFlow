...
export const adminSections: AdminSection[] = [
    ...
    { key: "chatgptApi", label: "GPTAPI", description: "管理 ChatGPT 账号、模型目录、魔法代理、兼容网关、API 密钥和请求日志。", shortDescription: "ChatGPT 网关", icon: <Bot className="size-4" /> },
...
export const adminSectionGroups: AdminSectionGroup[] = [
    ...
    { title: "上游配置", items: sectionsFor(["channels", "magicProxy", "runninghub", "geminiai", "geminiTools", "chatgptApi", "dreamina", "skills"]) },
