...
const WORKER_USER_HEADER = "x-dreamyo-worker-user-id";
const WORKER_CONTEXT_PREFIX = "dreamyo-worker-v1";
...
function maintenanceToken() {
    return process.env.DREAMYO_MAINTENANCE_TOKEN?.trim() || "";
}

function workerToken() {
    return process.env.DREAMYO_WORKER_TOKEN?.trim() || "";
}
