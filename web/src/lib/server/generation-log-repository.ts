    ...
    return [
        {
            ...
            taskKind: source.taskKind === "edit" ? "edit" : source.taskKind === "generation" ? "generation" : source.taskKind === "upscale" ? "upscale" : undefined,
            taskProvider: source.taskProvider === "openai" || source.taskProvider === "seedance" || source.taskProvider === "dreamina-cli" || source.taskProvider === "generation" ? source.taskProvider : undefined,
