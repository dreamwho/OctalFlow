...
const globalDataAdapter = globalThis as typeof globalThis & { __dreamyoProDataFileWriteQueues?: Map<string, Promise<void>> };
const dataFileWriteQueues = (globalDataAdapter.__dreamyoProDataFileWriteQueues ??= new Map<string, Promise<void>>());
