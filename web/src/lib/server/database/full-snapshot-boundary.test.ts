...
const originalProvider = process.env.DREAMYO_DATABASE_PROVIDER;

afterEach(() => {
    if (originalProvider === undefined) delete process.env.DREAMYO_DATABASE_PROVIDER;
    else process.env.DREAMYO_DATABASE_PROVIDER = originalProvider;
});
