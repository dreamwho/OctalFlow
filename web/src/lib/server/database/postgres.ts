...
const POSTGRES_TABLES = [
    ...
    "runninghub_apps",
    "runninghub_tasks",
    "runninghub_request_logs",
    "magic_proxy_settings",
    "gemini_tools_accounts",
    "gemini_tools_oauth_sessions",
    "gemini_tools_api_keys",
    "gemini_tools_gateway_settings",
    "gemini_tools_request_logs",
    "geminiai_request_logs",
    "geminiai_api_keys",
    "geminiai_gateway_settings",
    "dola_accounts",
    "dola_api_keys",
    "dola_gateway_settings",
    "dola_request_logs",
    "dola_attempts",
    "minimax_voices",
    "minimax_music_records",
    "minimax_request_logs",
    "aliyun_bailian_audio_records",
    "dreamina_cli_account_state",
    "dreamina_cli_request_logs",
    "entitlement_plans",
    "users",
    "sessions",
    ...
    "cloud_storage_reservations",
    "cloud_storage_objects",
    "cloud_storage_object_refs",
    "cloud_storage_project_backups",
    "desktop_device_requests",
...
const POSTGRES_SCHEMA_OBJECTS = [
    ...
    "gemini_tools_accounts_email_lower_idx",
    "runninghub_apps_remote_kind_idx",
    "runninghub_apps_binding_idx",
    "runninghub_apps_enabled_sort_idx",
    "runninghub_tasks_image_task_idx",
    "runninghub_tasks_status_created_idx",
    "runninghub_tasks_app_created_idx",
    "runninghub_request_logs_created_idx",
    "runninghub_request_logs_task_idx",
    "gemini_tools_accounts_route_idx",
    "gemini_tools_oauth_sessions_created_idx",
    "gemini_tools_api_keys_status_idx",
    "gemini_tools_request_logs_created_idx",
    "gemini_tools_request_logs_status_idx",
    "gemini_tools_request_logs_model_idx",
    "geminiai_request_logs_created_idx",
    "geminiai_request_logs_status_idx",
    "geminiai_request_logs_model_idx",
    "geminiai_api_keys_status_idx",
    "dola_accounts_route_idx",
    "dola_accounts_fingerprint_idx",
    "dola_api_keys_status_idx",
    "dola_request_logs_created_idx",
    "dola_request_logs_status_idx",
    "dola_request_logs_model_idx",
    "dola_request_logs_account_idx",
    "dola_attempts_task_idx",
    "minimax_voices_user_remote_idx",
    "minimax_voices_user_visible_idx",
    "minimax_music_records_user_created_idx",
    "aliyun_bailian_audio_records_created_idx",
    "aliyun_bailian_audio_records_user_created_idx",
    "minimax_request_logs_created_idx",
    "minimax_request_logs_user_idx",
    "minimax_request_logs_model_idx",
    "dreamina_cli_account_state_lease_idx",
    "dreamina_cli_request_logs_created_idx",
    "dreamina_cli_request_logs_task_idx",
    "dreamina_cli_request_logs_status_idx",
    "dreamina_cli_request_logs_model_idx",
    "dreamina_cli_request_logs_submit_lifecycle_idx",
    ...
    "runninghub_settings_set_updated_at",
    "runninghub_apps_set_updated_at",
    "runninghub_tasks_set_updated_at",
    "gemini_tools_accounts_set_updated_at",
    "gemini_tools_api_keys_set_updated_at",
    "gemini_tools_gateway_settings_set_updated_at",
    "dreamina_cli_account_state_set_updated_at",
    "dreamina_cli_request_logs_set_updated_at",
    ...
    "cloud_storage_create_account",
    "users_cloud_storage_account",
    "cloud_storage_grants_order_idx",
    "cloud_storage_grants_user_period_idx",
    "cloud_storage_reservations_user_expiry_idx",
    "cloud_storage_reservations_user_checksum_idx",
    "cloud_storage_objects_user_source_idx",
    "cloud_storage_objects_user_checksum_idx",
    "cloud_storage_object_refs_user_object_idx",
    "cloud_storage_object_refs_source",
    "cloud_storage_project_backups_user_time_idx",
    "cloud_storage_project_backups_project",
    "cloud_storage_project_backups_title",
    "desktop_device_requests_expiry_idx",
    "desktop_device_sessions_user_idx",
    "desktop_device_sessions_refresh_expiry_idx",
] as const;
