...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
    ...
    logoUrl: "/logo.svg",
    iconUrl: "/icon.svg",
    seoTitle: "OctalAICanvas",
    seoDescription: "面向 Agent、图片、视频、画布与短剧生产的一体化 AI 创作工作台",
    seoKeywords: "OctalAICanvas,AI Agent,AI 绘图,AI 视频,画布,短剧,提示词库,素材管理",
    footerCopyright: "© 2026 OctalAICanvas. All rights reserved.",
    termsUrl: "/terms",
    termsVersion: "1.0",
    privacyUrl: "/privacy",
    privacyVersion: "1.0",
