...
export default async function AdminPage({ searchParams }: AdminPageProps) {
    ...
    return (
        ...
        >
            <main className={`admin-console-page app-scroll-page relative bg-white text-zinc-950 dark:bg-zinc-950 dark:text-zinc-100 ${desktopEdition === "admin" ? "desktop-admin-console" : ""}`}>
                <AdminDashboard
                    initialUsers={[]}
