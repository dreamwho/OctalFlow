...
const globalCooldownStore = globalThis as typeof globalThis & { __dreamyoProModelFetchCooldowns?: Map<string, number> };
const modelFetchCooldowns = (globalCooldownStore.__dreamyoProModelFetchCooldowns ??= new Map<string, number>());
