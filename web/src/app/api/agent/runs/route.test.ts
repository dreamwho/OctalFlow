...
vi.mock("@/lib/server/generation-task-store", () => ({ withGenerationConcurrencyLimit: mocks.withGenerationConcurrencyLimit, effectiveGenerationConcurrencyLimit: (_role: string | undefined, limit: number) => limit }));
