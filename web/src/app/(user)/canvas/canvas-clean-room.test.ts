...
const removedCanvasEntrypoints = ["[id]/use-canvas-pointer-interactions.tsx", "components/dreamyo-canvas.tsx", "components/canvas-connections.tsx", "components/canvas-mini-map.tsx", "utils/canvas-connection-path.ts"];
