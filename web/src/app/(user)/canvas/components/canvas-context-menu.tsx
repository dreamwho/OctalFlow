...
export function CanvasNodeContextMenu({ menu, onClose, onDuplicate, onDelete, onRename }: { menu: ContextMenuState; onClose: () => void; onDuplicate: () => void; onDelete: () => void; onRename: () => void }) {
