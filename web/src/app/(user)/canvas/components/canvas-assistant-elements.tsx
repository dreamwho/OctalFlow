...
export function restoreCanvasAssistantConversationMessages(conversationId: string, messages: CreativeMessage[], skillNames: ReadonlyMap<string, string>): CanvasAssistantMessage[] {
