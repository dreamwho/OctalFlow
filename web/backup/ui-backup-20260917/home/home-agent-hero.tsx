...
import { Box, Check, ChevronDown, Clapperboard, Frame, Image as ImageIcon, Paperclip, Plus, Sparkles, UsersRound, Video, WandSparkles, type LucideIcon } from "lucide-react";
        ...
        <section className={styles.hero} data-page-hidden={pageHidden ? "true" : undefined} aria-labelledby="home-hero-title" onPointerMove={trackPointer} onPointerLeave={resetPointer}>
            <div ref={motionRef} className={styles.motionStage} data-testid="home-agent-halo" aria-hidden="true">
                <img
                    ...
                    src="/design/home/aurora-background.webp"
                    alt=""
                    onError={(event) => {
                    ...
                    <div className={styles.composer} data-testid="home-agent-card">
                        <div className={styles.promptField}>
                            ...
                            <textarea
                                ...
                                placeholder={`描述你想创作的内容，比如：${selectedMode.examples[0]}`}
                        ...
                        <div className={styles.composerToolbar}>
                            <div className={styles.leftControls}>
                                <Popover
                                    ...
                                    content={
                                        <div className={styles.pickerPanel} data-testid="home-mode-picker">
                                            <div className={styles.pickerHeader}>
                                                <div>
                                                    <strong>创作类型</strong>
                                                    <span>选择本轮生成的内容形态</span>
                                                </div>
                                            </div>
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <span className={styles.pickerItemIcon}>
                                                                <DreamyoIcon name={MODE_ICONS[item.id]} size={22} />
                                                            </span>
                                ...
                                >
                                    <button type="button" className={`${styles.toolControl} ${modeMenuOpen ? styles.toolControlActive : ""}`} aria-expanded={modeMenuOpen} aria-label={`当前创作模式：${selectedMode.label}`}>
                                        <DreamyoIcon name={MODE_ICONS[mode]} size={18} />
                                ...
                                <button type="button" className={styles.toolControl} onClick={() => fileInputRef.current?.click()}>
