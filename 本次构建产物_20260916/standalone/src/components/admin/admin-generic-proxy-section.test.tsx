...
describe("AdminGenericProxySection", () => {
    beforeEach(() => {
        ...
        fetchMock.mockResolvedValue(
            new Response(JSON.stringify({ code: 0, data: { groups: [], default_reference: { mode: "direct" }, fallback_reference: null, effective_default: { label: "直接连接" }, effective_fallback: { label: "关闭回退" }, revision: "1" }, msg: "OK" }), {
                status: 200,
            }),
        );
    });
