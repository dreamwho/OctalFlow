...
import { getMagicProxy, testChatGptChain, testMagicProxyGoogle, updateMagicProxyBinding, type MagicProxyGoogleTestReport, type MagicProxyNode, type MagicProxyProvider, type MagicProxyState } from "@/services/api/magic-proxy";
                    ...
                    <div className="space-y-4 rounded-xl border border-sky-100 bg-sky-50/40 p-3.5 dark:border-sky-950/60 dark:bg-sky-950/20 sm:p-4">
                        ...
                        <div className="rounded-lg border border-sky-200/80 bg-white/90 p-3 dark:border-sky-900/60 dark:bg-zinc-900/80">
                            ...
                            <div className="flex flex-wrap items-center gap-2 text-xs text-zinc-600 dark:text-zinc-400">
                                ...
                                <ArrowRight className="size-3 text-sky-500 shrink-0" />
                                <span className="rounded bg-purple-100 px-2 py-0.5 font-medium text-purple-800 dark:bg-purple-900/60 dark:text-purple-200">Google 官方服务</span>
                            </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div className="min-w-0">
                                ...
                                />
                                <div className="mt-1 text-[11px] text-zinc-500 dark:text-zinc-400">流量终点站：由境外跳板连接此节点，最终以该纯净住宅 IP 访问 {provider === "chatgptApi" ? "ChatGPT" : "Google"}。</div>
                            </div>
                        </div>
