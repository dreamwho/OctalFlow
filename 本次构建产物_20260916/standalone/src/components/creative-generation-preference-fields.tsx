            ...
            {allowCustom ? (
                <label
                    className={cn(
                        ...
                        customSelected ? "dreamyo-selection-surface" : "border-[#dce2e7] bg-white text-[#687481] focus-within:border-[#7da6ba] focus-within:ring-2 focus-within:ring-[#7da6ba]/15 dark:border-[#3e4650] dark:bg-[#181b20] dark:text-[#a6afb9]",
                    )}
                >
                    <input
    ...
    return (
        <button
            ...
            className={cn(
                ...
                selected ? "dreamyo-selection-surface font-semibold" : "bg-[#f5f6f7] text-[#687481] hover:bg-[#edf0f2] hover:text-[#20242a] dark:bg-[#24282e] dark:text-[#a6afb9] dark:hover:bg-[#30363e] dark:hover:text-white",
            )}
            onClick={onClick}
            aria-label={ariaLabel}
