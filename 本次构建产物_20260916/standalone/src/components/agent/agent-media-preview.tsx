    ...
    if (type === "image") {
        ...
        return (
            <div
                ref={mediaRootRef}
                className={cn(
                    "group/media relative overflow-hidden bg-transparent [&_.ant-image]:!block [&_.ant-image]:!size-full [&_.ant-image-img]:!block [&_.ant-image-img]:!size-full [&_.ant-image-img]:!border-0 [&_.ant-image-img]:!bg-transparent",
                    className,
                )}
            >
                <Image
