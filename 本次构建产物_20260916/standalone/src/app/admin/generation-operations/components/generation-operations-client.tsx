...
export function GenerationOperationsClient() {
    ...
    return (
        <>
            <div className="admin-generation-operations space-y-3 sm:space-y-4" data-admin-generation-operations="true">
                <Panel>
                    <PanelHeader
                        title="运行概览"
                    ...
                    />
                    <section className="admin-generation-summary-grid grid grid-cols-2 gap-px sm:grid-cols-3 xl:grid-cols-6">
                ...
                {data?.agentPerformance.sampleSize ? (
                    <Panel>
                        ...
                        />
                        <section className="admin-generation-performance-grid grid grid-cols-2 gap-px sm:grid-cols-4 xl:grid-cols-7">
...
function SummaryMetric({ icon, label, value, detail, tone = "default" }: { icon: React.ReactNode; label: string; value: string | number; detail: string; tone?: "default" | "danger" }) {
    return (
        <div className="admin-generation-summary-metric flex min-h-[94px] min-w-0 flex-col justify-between p-3 sm:min-h-28 sm:p-4">
...
function PerformanceValue({ label, value, detail, className = "" }: { label: string; value: number; detail: string; className?: string }) {
    return (
        <div className={`admin-generation-performance-value min-h-[82px] min-w-0 p-3 sm:min-h-24 sm:p-4 ${className}`}>
