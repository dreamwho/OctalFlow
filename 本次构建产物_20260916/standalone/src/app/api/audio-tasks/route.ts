                ...
                lifecycle: [
                    {
                        ...
                        phase: "queued",
                        message:
                            configs[0].advancedConfig?.protocol === "aliyun-bailian-audio"
                                ? "音频任务已提交，等待阿里云百炼执行"
                                : configs[0].advancedConfig?.protocol === "tencent-tokenhub-music"
                                  ? "音频任务已提交，等待腾讯云 TokenHub 执行"
                                  : "音频任务已提交，等待 MiniMax 执行",
                    },
                ],
