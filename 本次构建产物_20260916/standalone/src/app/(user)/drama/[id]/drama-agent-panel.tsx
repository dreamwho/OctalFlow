    ...
    if (!desktop)
        return (
            <Drawer
                ...
                motion={{ motionName: "", motionAppear: false, motionEnter: false, motionLeave: false }}
                onClose={() => onOpenChange(false)}
                rootClassName="drama-agent-drawer"
                rootStyle={{ width: "100vw", maxWidth: "100vw", overflowX: "clip" }}
                styles={{ wrapper: { width: "min(360px, calc(100vw - 8px))", maxWidth: "calc(100vw - 8px)" }, body: { padding: 0 } }}
                aria-label="项目 Agent"
            >
                {content}
            </Drawer>
