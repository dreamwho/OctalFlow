        ...
        <>
                ...
                content={
                    ...
                    >
                        <div className="flex items-start justify-between gap-3 pb-3">
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    smartPlanning ? "bg-[#e5f6f9] text-[#28738e] dark:bg-cyan-300/10 dark:text-cyan-100" : "text-[#637394] hover:bg-[#eef4f8] hover:text-[#294d77] dark:text-[#7f90aa] dark:hover:bg-white/[.05] dark:hover:text-white",
                                )}
                            ...
                            >
                                ...
                                <span
                                    className={cn(
                                        ...
                                        smartPlanning ? "border-cyan-300/60 bg-gradient-to-r from-[#566fff] to-[#42d7e7]" : "border-[#cbd8e8] bg-[#eaf0f7] dark:border-white/15 dark:bg-white/10",
                                    )}
                                >
                        ...
                        {modelCapabilities.length > 1 ? (
                            <div className={cn("mb-2 grid gap-1 rounded-xl border border-[#d7e7ef] bg-[#f3f8fb] p-1 dark:border-white/[.08] dark:bg-white/[.035]", modelCapabilities.length === 2 ? "grid-cols-2" : "grid-cols-3")}>
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                activeCapability === capability
                                                    ? "bg-gradient-to-r from-[#566fff]/15 to-[#42d7e7]/15 text-[#2f4c9a] shadow-[inset_0_0_0_1px_rgba(109,169,255,.25)] dark:from-[#566fff]/25 dark:to-[#42d7e7]/15 dark:text-white dark:shadow-[inset_0_0_0_1px_rgba(109,213,255,.2)]"
                                                    : "text-[#6d7d95] hover:bg-[#e9f2f7] hover:text-[#294d77] dark:text-[#7f90aa] dark:hover:bg-white/[.04] dark:hover:text-white",
                                            )}
                        ...
                        <div className="hide-scrollbar max-h-64 space-y-1 overflow-y-auto overscroll-contain">
                            {!models.some((model) => model.capability === activeCapability) ? <p className="px-2 py-5 text-center text-xs text-[#637394] dark:text-[#7f90aa]">当前未配置可用的{mediaCapabilityLabel(activeCapability)}模型</p> : null}
                            {models
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                selected
                                                    ? "border-[#b7d6ec] bg-gradient-to-r from-[#566fff]/10 to-[#42d7e7]/10 text-[#1f315a] dark:border-cyan-300/20 dark:from-[#566fff]/20 dark:to-[#42d7e7]/[.08] dark:text-white"
                                        ...
                                        >
                                            ...
                                            <span className="min-w-0 flex-1">
                                                ...
                                                <span className="mt-0.5 block text-[11px] leading-4 text-[#637394] dark:text-[#75869d]">{mediaCapabilityLabel(model.capability)}模型 · 可与其他模型同时生成</span>
                                            </span>
                                            <span
                                                className={cn(
                                                    "mt-1 grid size-4 shrink-0 place-items-center rounded border",
                                                    selected ? "border-cyan-200/70 bg-gradient-to-br from-[#566fff] to-[#42d7e7] text-white" : "border-[#cbd8e8] text-transparent dark:border-white/15",
                                                )}
                                            >
                        ...
                        {!smartPlanning && selectedModels.length ? (
                            <button
                                type="button"
                                className="mt-2 w-full rounded-lg px-2 py-2 text-xs font-medium text-[#637394] transition hover:bg-[#eef4f8] hover:text-[#294d77] dark:text-[#7f90aa] dark:hover:bg-white/[.05] dark:hover:text-white"
            ...
            >
                <Button type="text" className={creativeComposerToolButtonClass(modelPickerOpen)} icon={<Orbit className="size-4" />} aria-label={`生成模型：${modelSummary}`} aria-haspopup="menu" aria-expanded={modelPickerOpen}>
                    <span className="hidden max-w-[126px] truncate text-xs font-medium sm:inline sm:max-w-[172px]">{modelSummary}</span>
                </Button>
            </Popover>
