...
import {
    ...
    agentImageQualities,
    compactAgentPreferenceSummary,
    type AgentImageGenerationCapabilityProfile,
    type AgentVideoGenerationCapabilityProfile,
    updateAgentGenerationPreferences,
} from "@/components/agent/compact-agent-generation-settings";
...
export function CanvasAgentGenerationSettings({
    ...
    useEffect(() => {
        ...
        onChange(
            updateAgentGenerationPreferences(preferences, "image", {
