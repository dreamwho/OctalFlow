...
import { Link2, LoaderCircle, Maximize2, Minimize2 } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <section className="flex min-h-0 min-w-0 flex-1 flex-col px-3 pb-2">
                ...
                <div data-canvas-generation-bar className="box-border flex h-14 min-w-0 shrink-0 items-center gap-2 overflow-visible border-t py-2" style={{ borderColor: theme.toolbar.border }}>
                    ...
                    {!isRunning ? (
                        <span
                            ...
                            className="inline-flex h-9 shrink-0 items-center gap-1 rounded-full border px-2.5 text-xs font-semibold tabular-nums"
