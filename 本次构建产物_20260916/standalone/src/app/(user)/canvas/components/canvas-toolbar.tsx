...
export function CanvasToolbar({
    ...
    return (
        <div className="canvas-toolbar-dock-wrap pointer-events-none absolute left-0 right-0 z-50 flex justify-center transition-[top,bottom] duration-200" style={composerOpen ? { left: 0, right: 0, top: 72, bottom: "auto" } : { bottom: 20 }}>
