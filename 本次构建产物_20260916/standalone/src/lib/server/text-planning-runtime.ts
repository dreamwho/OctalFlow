...
export type TextPlanningMessageContent =
    | string
    | Array<
          { type: "text"; text: string } | { type: "image_url"; image_url: { url: string; mimeType?: string } } | { type: "video_url"; video_url: { url: string; mimeType?: string } } | { type: "audio_url"; audio_url: { url: string; mimeType?: string } }
      >;
