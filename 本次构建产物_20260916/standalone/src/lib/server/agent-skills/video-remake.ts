...
export const VIDEO_REMAKE_SKILLS: AgentSkill[] = [
    remakeSkill("video-remake-universal", "通用爆款复刻", "适配常见短视频，复刻结构、节奏与镜头语法并生成全新内容。", "先识别最接近的内容类型，再选用对应的叙事和镜头策略；无法确认时采用清晰的钩子—展开—证明—收束结构，不得虚构原片细节。", [
        "爆款复刻",
        "视频复刻",
        "通用复刻",
        "参考视频",
    ...
    remakeSkill("video-remake-product", "种草广告复刻", "复刻产品种草、测评和品牌短片的卖点节奏与展示镜头。", "按痛点钩子、产品出场、使用证明、细节特写、结果对比和行动召唤组织；所有品牌、包装、Logo、音乐与宣称必须替换为用户自己的资产和可验证信息。", [
        "种草复刻",
        "产品测评",
        "品牌广告",
        "TVC复刻",
    ...
    remakeSkill("video-remake-tutorial", "教程拆解复刻", "复刻教程、科普与操作演示的信息步骤和视觉解释节奏。", "按前置条件、步骤、关键操作、错误示例、结果验证和总结拆分；每段只承载一个可验证操作，画面必须能看清手部、界面或工具状态，不得省略关键步骤。", [
        "教程复刻",
        "科普复刻",
        "操作演示",
        "知识视频",
