...
import {
    CanvasVideoOperationError,
    authorizeCanvasVideoSource,
    materializeCanvasVideoSource,
    normalizeCanvasVideoStorageKey,
    probeCanvasVideoSource,
    type AuthorizedCanvasVideoSource,
    type CanvasVideoProbe,
} from "@/lib/server/canvas-video-source-service";
...
async function extractFrame(sourcePath: string, workdir: string, atMs: number, input: ExtractCanvasVideoFramesInput, source: AuthorizedCanvasVideoSource, probe: CanvasVideoProbe, suffix = "current"): Promise<CanvasExtractedVideoFrame> {
...
async function persistFrame(outputPath: string, atMs: number, input: ExtractCanvasVideoFramesInput, source: AuthorizedCanvasVideoSource, probe: CanvasVideoProbe, suffix: string): Promise<CanvasExtractedVideoFrame> {
