...
function matches(log: GeminiAiRequestLog, input: { keyword: string; status?: "success" | "failed"; capability?: GeminiAiRequestCapability; source?: GeminiAiRequestSource; model?: string; accountId?: string }) {
