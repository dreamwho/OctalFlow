...
const mocks = vi.hoisted(() => {
    ...
    return {
        ...
        listDramaRenderTasksForProject: vi.fn(),
...
vi.mock("@/lib/server/drama-render-store", () => ({ listDramaRenderTasksForProject: mocks.listDramaRenderTasksForProject }));
...
describe("drama project service updates", () => {
    beforeEach(() => {
        ...
        mocks.listDramaRenderTasksForProject.mockResolvedValue([]);
