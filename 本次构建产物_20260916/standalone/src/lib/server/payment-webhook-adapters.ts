...
const customWebhookAdapter: PaymentWebhookAdapter = {
    parse(provider, rawBody, headers, paymentConfig) {
        ...
        return {
            ...
            orderNo: normalizeOptionalId(readConfiguredPath(paymentConfig, payload, `${fieldPrefix}_WEBHOOK_ORDER_NO_FIELD`, ["orderNo", "outTradeNo", "out_trade_no", "data.orderNo", "data.outTradeNo", "metadata.orderNo", "metadata.dreamyoProOrderNo"])),
