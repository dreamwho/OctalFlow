...
describe("importMigrationDomains", () => {
    it("maps every scoped FILE-provider domain without mutating the supplied snapshot", async () => {
        ...
        for (const table of ["canvas_projects", "creative_conversations", "creative_messages", "creative_assets", "creative_run_events", "drama_projects", "drama_project_versions", "library_assets", "local_media_assets", "audit_logs"]) {
