...
async function importCreativeRuntime(client: QueryExecutor, file: JsonRecord, fileName: string) {
    ...
    for (const event of events) {
        await client.query("INSERT INTO creative_run_events (id, run_id, type, data, created_at) VALUES ($1, $2, $3, $4::jsonb, $5)", [
...
async function importLibraryAssets(client: QueryExecutor, file: JsonRecord, fileName: string) {
    ...
    for (const item of assets) {
        ...
        await client.query("INSERT INTO library_assets (id, user_id, kind, title, asset_json, created_at, updated_at) VALUES ($1, $2, $3, $4, $5::jsonb, $6, $7)", [
