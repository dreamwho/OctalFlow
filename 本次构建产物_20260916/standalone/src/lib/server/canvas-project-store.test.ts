...
describe("canvas project file provider", () => {
    ...
    it("migrates legacy default canvas titles without changing custom project names", async () => {
        ...
        await createCanvasProject("user-one", project("octalflow", "OctalFlow 画布 2"));
        ...
        await expect(getCanvasProject("octalflow", "user-one")).resolves.toMatchObject({ title: "dreamyo 画布 2" });
