...
const globalCache = globalThis as typeof globalThis & { __dreamyoProSafeOutboundDispatchers?: Map<string, CachedDispatcher> };
const dispatchers = (globalCache.__dreamyoProSafeOutboundDispatchers ??= new Map<string, CachedDispatcher>());
