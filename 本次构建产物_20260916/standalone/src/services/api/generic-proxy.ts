...
export const saveGenericProxyBinding = (input: { provider: string; enabled: boolean; target?: string }) => genericProxyRequest<GenericProxyBindings>("proxy/generic-bindings", { method: "POST", body: JSON.stringify(input) });
