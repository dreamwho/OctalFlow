        ...
        if (endpoint === "proxy-selection") {
            ...
            data = {
                ...
                buckets: Array.from({ length: 24 }, (_, index) => ({
                    ...
                    start_at: `2026-09-08T${String(index).padStart(2, "0")}:00:00`,
                    total_calls: index === 0 ? 3 : 0,
                    success_calls: index === 0 ? 2 : 0,
                    final_failed_calls: index === 0 ? 1 : 0,
                })),
            ...
            data = { items: allQuotaRefresh ? [{ id: "fixture-quota-log", model: "账号额度刷新", presentation: { summary_text: logFinished ? "全部账号额度刷新 · 已完成" : "全部账号额度刷新 · 执行中" } }] : [], total: allQuotaRefresh ? 1 : 0 };
        else if (endpoint === "logs/fixture-quota-log")
            data = {
                id: "fixture-quota-log",
                model: "quota_refresh",
                ...
                ended_at: logFinished ? "2026-09-08 12:00:03" : "",
