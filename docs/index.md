...
dreamyo 是面向图片、视频、短剧与品牌物料生产的 AI 创作工作台。当前仓库：`dreamwho/dreamyo`。
...
- 应用镜像为 `ghcr.io/dreamwho/dreamyo`，文档镜像为 `ghcr.io/dreamwho/dreamyo-docs`。
- 环境变量统一使用 `DREAMYO_` 前缀；数据库默认名称与用户为 `dreamyo`。
