...
async def messages(req: AnthropicMessageRequest, response: Response, client: AIStudioClient = Depends(get_client)):
    result = await handle_anthropic_messages(req, client)
