...
class RuntimeState:
    ...
    # AI Studio uses one persistent browser session.  Account switching and
    # request execution therefore need a separate exclusive lock; the
    # semaphore above remains the admission/concurrency limit for callers.
    account_request_lock: asyncio.Lock | None = None
